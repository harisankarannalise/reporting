...
def generate_text_report(input_dir, output_dir):
    ...
    for path in paths:
        ...
        d['accession'] = path.replace('/', '/').split('/')[-1].replace('.json', '')
...
if __name__ == '__main__':
    ...
    parser.add_argument("input_dir", help="Path to the input directory", default=os.path.join("txt_report_gen", "cxrjsons"))
    parser.add_argument("output_dir", help="Path to the output directory", default=os.path.join("ai_outputs", "report_output"))
